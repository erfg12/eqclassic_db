...
-- Dumping structure for table eqclassic.faction_values
...
-- Dumping data for table eqclassic.faction_values: ~428 rows (approximately)
/*!40000 ALTER TABLE `faction_values` DISABLE KEYS */;
INSERT INTO `faction_values` (`char_id`, `faction_id`, `current_value`) VALUES
	(5, 5, -30),
	(5, 41, -1500),
	(5, 63, -1500),
	(5, 92, -1080),
