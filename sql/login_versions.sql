...
-- Dumping structure for table eqclassic.login_versions
...
-- Dumping data for table eqclassic.login_versions: ~0 rows (approximately)
/*!40000 ALTER TABLE `login_versions` DISABLE KEYS */;
INSERT INTO `login_versions` (`approval`, `version`) VALUES
	(1, '10-18-2001 12:07');
